  ...
  const [isFocused, setIsFocused] = useState(false);
    ...
    return (
      ...
      >
        ...
        <motion.input
          className="h-[52px] w-full rounded-xl border-2 border-slate-200 bg-white px-3.5 py-3 tracking-[0.4em] text-slate-900 outline-none placeholder:tracking-normal placeholder:text-slate-400 focus:border-slate-900"
          type="password"
          ...
          animate={{ ...borderAnimation, ...matchAnimation }}
        />
      </div>
    );
  }
